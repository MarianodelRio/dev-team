...
[![Release](https://img.shields.io/badge/version-1.2.0-blue)](https://github.com/MarianodelRio/dev-team/releases)
...
3. Run `/bootstrap` — collaborative design conversation that generates architecture (`design.md`), module behavioral specs (`spec.md`), plan, and tasks
...
- `spec.md` — module behavioral specifications: what each module does, its logic, interface, and edge cases; bridge between architecture and tasks
...
**Spec-first** — Design, behavioral spec (`spec.md`), and plan are all approved before any code is written. `spec.md` is the canonical source for "what should this module do" — the Architect validates task scope against it before implementation starts. The human checkpoint is mandatory and cannot be skipped.
...
/refine [description]   Update spec.md mid-project with state-aware propagation to affected tasks
