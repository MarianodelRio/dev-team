...
Three model slots, each can be any Claude model or an alternative:
  ...
  reasoning     → architecture, Advisor, design decisions
                  (applies to: advisor.md, architect.md)
  Current: [value]

  implementation → writing code, implementing tasks
                   (applies to: orchestrator.md, pr-reviewer.md, code-quality.md,
...
|------|-----------------------|
| `reasoning` | `.claude/agents/advisor.md`, `.claude/agents/architect.md` |
| `implementation` | `.claude/agents/orchestrator.md`, `.claude/agents/pr-reviewer.md`, `.claude/agents/code-quality.md`, `.claude/agents/adversarial.md`, `.claude/agents/security.md`, `.claude/agents/smoke-tester.md`, `.claude/agents/mutation-tester.md` |
